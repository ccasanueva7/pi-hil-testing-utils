...
def main():
    ...
    parser.add_argument(
        "--labnet", type=Path, help="Path to labnet.yaml (default: OPENWRT_TESTS_DIR or sibling openwrt-tests)"
    )
    ...
    if args.labnet is None or args.template is None:
        ...
        if args.template is None:
            args.template = openwrt_root / "ansible" / "files" / "coordinator" / "places.yaml.j2"
